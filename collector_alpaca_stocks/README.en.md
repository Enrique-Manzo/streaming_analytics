...
### 4. Install dependencies and configure credentials
...
pm2 logs alpaca-collector         # Stream logs in real time
pm2 restart alpaca-collector      # Restart the process
pm2 stop alpaca-collector         # Stop the process
pm2 delete alpaca-collector       # Remove the process from PM2
```
